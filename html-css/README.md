...
1. In the file `.github/workflows/linters.yml` [line 48](https://github.com/Chill Academyinc/linters-config/blob/master/html-css/.github/workflows/linters.yml#L48) replace `"**/*.{css,scss}"` with `"**/*.scss"`
